...
namespace Personal_takip_1
{
    public partial class frmPersonelListele : Form
    {
        ...
        {
            Veritabanı.Listele_Ara(dataGridView1, "select p.PersonelID,p.Adi,p.Soyadi,p.Telefon,p.Adres,p.Email,d.Departman,p.Durumu,p.Maasi,p.Maasi,p.GirisTarihi,p.Aciklama,p.C_Durumu from personeller p,departmanlar d where p.DepartmanID=d.DepartmanID");
        ...
        private void btnSil_Click(object sender, EventArgs e)
        {
            ...
            //Veritabanı.ESG(cmd, sorgu);
            string sorgu2 = "update personeller set C_Durumu='Pasif' where PersonelID=@PersonelID";
